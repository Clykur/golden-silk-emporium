...
export default function AdminDashboard() {
  ...
  const { data, isLoading } = useQuery({
    queryKey: ["admin-command-center", dateRange],
    queryFn: () => adminStatsApi.getCommandCenterData({ dateRange }),
  ...
  const dateRangeAction = (
    <div className="flex items-center gap-2 bg-white p-1 rounded-xl w-48">
