            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <label className="block">
                ...
                <input
                  ...
                  className="w-full border border-border bg-background px-4 py-2.5 text-sm focus:border-foreground focus:outline-none"
              ...
              <label className="block">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full border border-border bg-background px-4 py-2.5 pr-12 text-sm focus:border-foreground focus:outline-none"
              ...
              <label className="block">
                ...
                <input
                  ...
                  className={`w-full border bg-background px-4 py-2.5 text-sm focus:outline-none ${
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-foreground py-3.5 mt-2 text-xs font-medium tracking-[0.25em] uppercase text-background transition-colors hover:bg-gold hover:text-gold-foreground disabled:opacity-50"
              >
