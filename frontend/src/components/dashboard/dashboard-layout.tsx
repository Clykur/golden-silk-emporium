...
import {
  LayoutDashboard, Package, MapPin, Heart, Bell, User, Shield,
  HelpCircle, RotateCcw, LogOut, Menu, X, ChevronRight, CreditCard,
} from "lucide-react";
...
const NAV_ITEMS = [
  ...
  { to: "/dashboard/returns", label: "Returns & Refunds", icon: RotateCcw },
  { to: "/dashboard/notifications", label: "Notifications", icon: Bell },
  { to: "/dashboard/support", label: "Support Tickets", icon: HelpCircle },
